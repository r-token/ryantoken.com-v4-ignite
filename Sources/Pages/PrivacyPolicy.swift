...
struct PrivacyPolicy: StaticPage {
    ...
    var body: some HTML {
        ...
        HeaderText("Gathering of Personally-Identifying Information", size: .h2)
        ...
        HeaderText("Protection of Certain Personally-Identifying Information", size: .h2)
        ...
        HeaderText("Business Transfers", size: .h2)
        ...
        HeaderText("Privacy Policy Changes", size: .h2)
        ...
        HeaderText("Limited Warranties", size: .h2)
